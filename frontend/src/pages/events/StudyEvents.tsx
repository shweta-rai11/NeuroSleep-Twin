...
import type { RespiratoryEvent, RespiratoryEventsResult, StudyDetail } from "@/types/study";
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <p className="mt-1 text-sm text-slate-600">
        {study.display_name || study.record_name} — candidate events from an amplitude-envelope
        detector ({result.algorithm_version ?? "n/a"}). A machine-learning estimate, not a
        clinical scoring.
      </p>
